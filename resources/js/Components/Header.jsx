            ...
            <div className="offcanvas-wrapper">
                <div className="offcanvas-content">
                        ...
                        <ul>
                            <li className="d-flex gap-15">
                                ...
                                <div className="offcanvas-contact-text">
                                    <Link href="#"> {settings?.address || '374 William S Canning Blvd, Fall River MA Road 2721, USA'} </Link>
                                </div>
                            </li>
                            <li className="d-flex gap-15">
                                <div className="offcanvas-contact-icon">
                                ...
                                <div className="offcanvas-contact-text">
                                    <a href={`tel:${settings?.contactNumber || '+12346691234'}`}> {settings?.contactNumber || '+123-4669-1234'} </a>
                                </div>
                            </li>
                            <li className="d-flex gap-15">
                                <div className="offcanvas-contact-icon">
                                ...
                                <div className="offcanvas-contact-text">
                                    <a href={`mailto:${settings?.supportEmail || 'univet@gmail.com'}`}>{settings?.supportEmail || 'univet@gmail.com'}</a>
                                </div>
                            </li>
                        </ul>
                    </div>
                    <div className="offcanvas-social">
                        ...
                        <ul>
                            {settings?.facebookLink && <li><a href={settings.facebookLink} target="_blank" rel="noopener noreferrer"><i className="ri-facebook-fill"></i></a></li>}
                            {settings?.twitterLink && <li><a href={settings.twitterLink} target="_blank" rel="noopener noreferrer"><i className="ri-twitter-x-fill"></i></a></li>}
                            {settings?.instagramLink && <li><a href={settings.instagramLink} target="_blank" rel="noopener noreferrer"><i className="ri-instagram-fill"></i></a></li>}
                            {settings?.linkedinLink && <li><a href={settings.linkedinLink} target="_blank" rel="noopener noreferrer"><i className="ri-linkedin-box-fill"></i></a></li>}
