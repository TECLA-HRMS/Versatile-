...
export default function Edit({ user, roles }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        put(`${window.AppAssetUrl || '/'}admin/users/${user.id}`);
    };
    ...
    return (
        <AdminLayout>
            ...
            <div className="admin-page-header d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h2 className="admin-page-title h4 mb-0">Edit User</h2>
                    <p className="text-muted mb-0">Update user details and roles</p>
                </div>
                            ...
                            <div className="col-12 mt-2">
                                ...
                                <div className="row g-3 mb-4">
                                    <div className="col-md-4">
                                        <label className={`w-100 p-3 border rounded-3 d-flex align-items-center gap-3 transition-all ${data.password_type === 'keep' ? 'border-primary bg-primary bg-opacity-10' : 'bg-light border-light'}`} style={{ cursor: 'pointer', transition: 'all 0.2s ease-in-out' }}>
                                            <input type="radio" name="password_type" value="keep" className="form-check-input mt-0" checked={data.password_type === 'keep'} onChange={e => setData('password_type', e.target.value)} style={{ transform: 'scale(1.2)' }} />
                                            <div>
                                                <div className="fw-semibold text-dark" style={{ fontSize: '15px' }}>Keep Current</div>
                                                <div className="text-muted" style={{ fontSize: '13px' }}>Leave password unchanged</div>
                                            </div>
                                        </label>
                                    </div>
                                    <div className="col-md-4">
                                        <label className={`w-100 p-3 border rounded-3 d-flex align-items-center gap-3 transition-all ${data.password_type === 'auto' ? 'border-primary bg-primary bg-opacity-10' : 'bg-light border-light'}`} style={{ cursor: 'pointer', transition: 'all 0.2s ease-in-out' }}>
                                            ...
                                            <div>
                                                <div className="fw-semibold text-dark" style={{ fontSize: '15px' }}>Auto-generate</div>
                                                <div className="text-muted" style={{ fontSize: '13px' }}>System creates new password</div>
                                            </div>
                                        </label>
                                    </div>
                                    <div className="col-md-4">
                                        <label className={`w-100 p-3 border rounded-3 d-flex align-items-center gap-3 transition-all ${data.password_type === 'manual' ? 'border-primary bg-primary bg-opacity-10' : 'bg-light border-light'}`} style={{ cursor: 'pointer', transition: 'all 0.2s ease-in-out' }}>
                                            ...
                                            <div>
                                                ...
                                                <div className="text-muted" style={{ fontSize: '13px' }}>Set specific new password</div>
                                            </div>
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div className="col-12 mt-2">
                                    <div className="p-3 border rounded-3 d-flex align-items-center justify-content-between flex-wrap gap-3" style={{ background: '#f8f9fa' }}>
                                        <div className="d-flex align-items-center gap-3">
                                            ...
                                            <div>
                                                <div className="fw-semibold text-dark mb-1" style={{ fontSize: '15px' }}>Send Password Reset Email</div>
                                                <div className="text-muted" style={{ fontSize: '13px' }}>Automatically email the user their newly changed login credentials.</div>
                                            </div>
                                        </div>
