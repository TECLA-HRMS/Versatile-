...
export default function Edit({ popup }) {
                    ...
                    <form onSubmit={handleSubmit} className="settings-form">
                        ...
                        <div className="form-group row mb-4">
                            <div className="col-md-4">
                                ...
                                <span className="form-help">(Optional) Upload an image poster to display. Leave blank to keep the current image.</span>
                            </div>
                            <div className="col-md-8">
                                <label className="image-upload-zone" style={{display: 'block', cursor: 'pointer', textAlign: 'center'}}>
                                    {data.image ? (
                                        ...
                                        <img src={window.assets(popup.image)} alt="Current Popup" style={{maxHeight: '120px', marginBottom: '10px'}} />
                                    ) : (
                                        <i className="ri-image-add-line image-upload-icon"></i>
                                    )}
                                    <div className="fw-medium text-dark">Select Image (to change)</div>
                        ...
                        <div className="form-actions text-end mt-4 pt-3 border-top">
                            <button type="submit" className="btn-primary" disabled={processing}>Update Popup</button>
                        </div>
                    </form>
                </div>
            </div>
