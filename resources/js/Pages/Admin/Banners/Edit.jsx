    ...
    return (
        <AdminLayout title="Edit Banner">
            <div className="page-title-box d-flex justify-content-between align-items-center mb-4">
                <h3 className="page-title mb-0">Edit Banner</h3>
                    ...
                    <form onSubmit={handleSubmit} className="settings-form">
                        ...
                        <div className="form-group row mb-4">
                            <div className="col-md-4">
                                ...
                                <span className="form-help">Upload a new image to replace current (Recommended size: 1920x1080)</span>
                            </div>
                            <div className="col-md-8">
                                <label className="image-upload-zone" style={{display: 'block', cursor: 'pointer', textAlign: 'center'}}>
                                    {data.image ? (
                                        ...
                                        <img src={window.assets(banner.image)} alt="Current" style={{maxHeight: '120px', marginBottom: '10px'}} />
                                    ) : (
                                        <i className="ri-image-add-line image-upload-icon"></i>
                                    )}
                                    <div className="fw-medium text-dark">Select Image (Optional)</div>
                        ...
                        <div className="form-actions text-end mt-4 pt-3 border-top">
                            <button type="submit" className="btn-primary" disabled={processing}>Update Banner</button>
                        </div>
                    </form>
                </div>
            </div>
